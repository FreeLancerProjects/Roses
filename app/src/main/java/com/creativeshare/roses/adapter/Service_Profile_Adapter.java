...
public class Service_Profile_Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
...
private String current_lang;
    public Service_Profile_Adapter(List<Market_model.MarketService> data, Context context, Fragment fragment) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            ...
            View view = LayoutInflater.from(context).inflate(R.layout.service_profile_row, parent, false);
...
if(current_lang.equals("ar")) {
    ((MyHolder) holder).tv_service.setText(data1.getService_ar_title());
}
else {
    ((MyHolder) holder).tv_service.setText(data1.getService_en_title());
